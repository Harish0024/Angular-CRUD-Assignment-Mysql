...
addcontact(cdata:any):any{
 ...
 updatecontact(cdata:any){
   this.httpClient.post('http://localhost:5051/updatecontact',cdata.value).subscribe((response)=>
 ...
 deletecontact(cdata:any){
   this.httpClient.post('http://localhost:5051/deletecontact',cdata.value).subscribe((response)=>
   {
     this.contactList=response;
     console.log(this.userList);
   });
